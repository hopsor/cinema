defmodule CinemaWeb.Router do
  ...
  scope "/", CinemaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CinemaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CinemaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CinemaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", CinemaWeb do
    ...
    live_session :current_user,
      on_mount: [{CinemaWeb.UserAuth, :mount_current_user}] do
